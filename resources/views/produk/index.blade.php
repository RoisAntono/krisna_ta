...
<div class="row">
    ...
    <div class="col-sm-4 mb-3">
        <div class="card" style="width: 18rem;">
            <img src="{{asset("img/home-decor-3.jpg")}}" class="card-img-top" alt="...">
            <div class="card-body">
            ...
            <div class="container">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Stock : {{ $produk->stock }}</li>
                    <li class="list-group-item">Harga : Rp. {{ $produk->harga }}</li>
                </ul>
            </div>
